    ...
    public class BuffProfile {
        ...
        private void FetchTreeStatsProfile() {
            try {
                ...
                var url = string.Format(@"http://treestats.net/{0}/{1}.json?t={2}&client=DoThingsBot", CoreManager.Current.CharacterFilter.Server, encodedName, DateTime.UtcNow.ToFileTimeUtc());
